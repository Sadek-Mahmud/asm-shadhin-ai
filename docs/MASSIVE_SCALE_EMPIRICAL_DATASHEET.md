...
**Execution Timestamp**: `2026-09-20 11:13:51 UTC`  
...
| **99th Percentile Latency ($p_{99}$)** | **20.79 µs** | Bounded wire-speed SLA | $< 2.0\ \mu\text{s}$ | **PASSED** |
...
ACTUAL MALICIOUS         2,971,838 (TP)               26,427 (FN)       2,998,265
ACTUAL BENIGN                    0 (FP)            7,001,735 (TN)       7,001,735
----------------------------------------------------------------------------------------
TOTAL PREDICTED          2,971,838                   7,028,162      10,000,000
========================================================================================
```

### Statistical Analysis:
1. **True Positive Rate (TPR / Sensitivity):**  
   $$\text{TPR} = \frac{\text{TP}}{\text{TP} + \text{FN}} = \frac{2,971,838}{2,998,265} = \mathbf{99.12\%}$$
